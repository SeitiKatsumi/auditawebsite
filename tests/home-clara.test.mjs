...
test('light proposal preserves service navigation, accessible chart and isolated theme', () => {
  ...
  for (const text of ['/analise-de-vendedor', '/analise-cobrancas-indevidas', 'pis-pasep', 'dividas-bancarias', 'contas-de-luz', 'consulta-de-imoveis', 'TIPI', '<details', 'role="meter"', 'aria-valuenow={value}', 'aria-label={label}', 'width: `${value}%`', 'entre famílias endividadas', 'index: false']) assert.ok(page.includes(text), text);
