...
test('light proposal preserves service navigation, accessible chart and isolated theme', () => {
  ...
  for (const text of ['/analise-de-vendedor', '/analise-cobrancas-indevidas', 'pis-pasep', 'dividas-bancarias', 'contas-de-luz', 'consulta-imoveis', 'TIPI', '<details', '<meter', 'aria-label={label}', 'entre famílias endividadas', 'index: false']) assert.ok(page.includes(text), text);
