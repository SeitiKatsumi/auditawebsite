...
export const metadata: Metadata = {
  ...
  description: "Descubra seguros e cobranças que você não reconhece em faturas do Itaú e Itaucard. A IA Audita organiza os documentos, os valores e as evidências.",
  alternates: { canonical: "/analise-cobrancas-indevidas" },
  openGraph: {
    title: "O Itaú cobrou um seguro que você não contratou?",
    description: "Envie faturas e extratos. A IA Audita encontra os lançamentos, organiza as provas e calcula o que aparece nos documentos.",
